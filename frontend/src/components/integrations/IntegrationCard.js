...
const IntegrationCard = ({ provider, integration, onConnect, onDisconnect, onSyncNow, onConfigure, connectingProvider, disconnectingProvider, syncingProviders, }) => {
